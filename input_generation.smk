...
rule main:
    input:
        ...
        # "{data_dir}/our_input/potts/{domain}_FN.csv",
        # "{data_dir}/our_input/potts/{domain}_h.pkl",
        # "{data_dir}/our_input/potts/{domain}_J.pkl",
...
rule reformat:
    ...
    shell:
        """
        ./data/pipeline_tools/hh-suite/scripts/reformat.pl a3m fas  \
            {input[0]}            \
            {output[0]}
        """
...
rule pssm:
    ...
    output:
        "{data_dir}/our_input/pssm/{domain}.csv",
    shell:
        """
        python ./scripts/pipeline_scrips/pssm.py \
            input[0] \
            output[0]
        """
